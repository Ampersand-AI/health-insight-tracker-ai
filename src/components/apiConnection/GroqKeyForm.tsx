...
import { testConnection } from "@/services/groqClient";

const apiKeySchema = z.object({
  apiKey: z.string().min(1, { message: "Please enter your Groq API key" }),
});

export const GroqKeyForm = () => {
    ...
    try {
      ...
      if (isSuccessful) {
        ...
        toast({
          ...
          description: "Your Groq API key appears to be invalid",
          variant: "destructive",
        });
      }
    } catch (error) {
      ...
      toast({
        title: "Connection Failed",
        description: "Could not connect to Groq. Please check your internet connection and try again.",
        variant: "destructive",
      });
    }
  };
  ...
  const resetApiKey = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        title: "API Key Reset",
        description: "Your Groq API key has been reset",
      });
    ...
    <Card className="border-neutral-800">
      <CardHeader className="bg-neutral-900">
        ...
        <CardDescription className="text-neutral-400">
          Connect your Groq API key to enable health report scanning and analysis with Llama 3.1
        </CardDescription>
      </CardHeader>
          ...
          <div className="flex items-start p-4 mb-4 border border-neutral-800 bg-neutral-900 rounded-md">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-400">
                Your Groq API key is saved and ready to use
              </p>
            </div>
          </div>
        )}
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-neutral-300">Groq API Key</FormLabel>
                  <FormControl>
                    <Input
                      placeholder="gsk_..."
                      type="password"
            ...
            <div className="flex items-start p-4 border border-neutral-800 bg-neutral-900 rounded-md">
              ...
              <div className="text-sm text-neutral-400">
                <p>To get a Groq API key:</p>
                <ol className="list-decimal list-inside mt-1 text-xs space-y-1 ml-1">
                  <li>Go to <a href="https://console.groq.com/keys" target="_blank" rel="noreferrer" className="underline text-neutral-300">console.groq.com/keys</a></li>
                  <li>Create an account or log in</li>
                  <li>Create a new API key</li>
                  <li>Copy and paste it here</li>
                </ol>
                <p className="mt-2 text-xs">This app uses Groq's Llama 3.1 API for OCR and analysis. You will be charged based on Groq's pricing.</p>
              </div>
            </div>
